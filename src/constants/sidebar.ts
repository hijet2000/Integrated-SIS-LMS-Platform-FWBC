...
export const SCHOOL_SIDEBAR: NavItem[] = [
  ...
  },
  {
    label: 'Attendance',
    children: [
        { label: 'Attendance Dashboard', path: '/school/:siteId/attendance', scope: 'attendance:read' },
        { label: 'Bulk Entry', path: '/school/:siteId/attendance/bulk', scope: 'attendance:write' },
        { label: 'View Records', path: '/school/:siteId/attendance/records', scope: 'attendance:read' },
        { label: 'Analytics', path: '/school/:siteId/attendance/analytics', scope: 'attendance:read' },
        { label: 'Exports & Heatmap', path: '/school/:siteId/attendance/exports', scope: 'attendance:read' },
  ...
  },
  {
  ...
  },
   {
    label: 'Library',
    children: [
        { label: 'Book List', path: '/school/:siteId/library/book-list', scope: 'library:read' },
        { label: 'Issue / Return', path: '/school/:siteId/library/issue-return', scope: 'library:write' },
        { label: 'Add Member', path: '/school/:siteId/library/add-member', scope: 'library:write' },
        { label: 'Digital Library', path: '/school/:siteId/library/digital', scope: 'library:read' },
