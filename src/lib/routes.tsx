...
const AttendanceDashboard = React.lazy(() => import('@/pages/attendance/Attendance'));
const BulkEntry = React.lazy(() => import('@/pages/attendance/BulkEntry'));
const AttendanceRecords = React.lazy(() => import('@/pages/attendance/AttendanceRecords'));
const AttendanceAnalytics = React.lazy(() => import('@/pages/attendance/Analytics'));
const ExportsDashboard = React.lazy(() => import('@/pages/attendance/ExportsDashboard'));
...
const routes: AppRoute[] = [
    ...
    // Attendance
    { path: '/school/:siteId/attendance', element: <AttendanceDashboard />, scope: 'attendance:read' },
    { path: '/school/:siteId/attendance/bulk', element: <BulkEntry />, scope: 'attendance:write' },
    { path: '/school/:siteId/attendance/records', element: <AttendanceRecords />, scope: 'attendance:read' },
    { path: '/school/:siteId/attendance/analytics', element: <AttendanceAnalytics />, scope: 'attendance:read' },
    { path: '/school/:siteId/attendance/exports', element: <ExportsDashboard />, scope: 'attendance:read' },
    ...
    // Library
    { path: '/school/:siteId/library/book-list', element: <BookList />, scope: 'library:read' },
    { path: '/school/:siteId/library/issue-return', element: <IssueReturn />, scope: 'library:write' },
