...
// FIX: Corrected import names for student-related setup APIs.
import { 
    studentCategoryApi,
    studentHouseApi,
    disableReasonApi,
...
type CategoryKey = 'categories' | 'houses' | 'reasons';

const categoryConfig = {
    categories: {
        title: 'Student Categories',
        api: studentCategoryApi,
        queryKey: 'studentCategories',
    },
    houses: {
        title: 'Student Houses',
        api: studentHouseApi,
        queryKey: 'studentHouses',
    },
    reasons: {
        title: 'Disable Reasons',
        api: disableReasonApi,
        queryKey: 'disableReasons',
    },
};
...
const Categories: React.FC = () => {
    ...
    const tabs: { key: CategoryKey; label: string }[] = [
        ...
        { key: 'reasons', label: 'Disable Reasons' },
    ];
    ...
    return (
        <div>
            <PageHeader
                title="Student Categories"
                subtitle="Manage categories, houses, and disable reasons for student records."
            />
